---
title: Migrate from WordPress to EmDash
description: A step-by-step WordPress to EmDash migration guide covering exports, content import, media, taxonomies, and redirect planning.
...
If you want a higher-level migration overview first, read [WordPress to Astro with EmDash](/wordpress-to-astro-with-emdash/) and [EmDash vs WordPress](/emdash-vs-wordpress/).
